                  ...
                  <div className="flex-1">
                    {recipientStatus.length > 0 ? (
                      recipientStatus.map((status, idx) => {
                        // Ensure read is explicitly true, not just truthy
                        ...
                        return (
                          ...
                          >
                            <span className={`w-2 h-2 rounded-full ${isRead ? 'bg-emerald-500' : 'bg-slate-400'}`} />
                            <span className="font-semibold">{status.email}</span>
                            <span className={`text-xs ${isRead ? 'text-emerald-700' : 'text-slate-500'}`}>
                              {isRead ? (
                                <>
